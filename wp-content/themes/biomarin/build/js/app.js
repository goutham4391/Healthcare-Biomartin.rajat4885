...
gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].registerPlugin(gsap_CSSPlugin__WEBPACK_IMPORTED_MODULE_2__["CSSPlugin"]);

new modal_video__WEBPACK_IMPORTED_MODULE_0___default.a(".js-video-btn", {
  channel: 'youtube'
...
$('[href*="#"]') // Remove links that don't actually link to anything
...
function loadAnim() {
  ...
  var btn = document.querySelectorAll('.blurb .btn');
  var nav = document.querySelectorAll('nav .nav-link ul li a'); // Header Anim

  var tl = new gsap__WEBPACK_IMPORTED_MODULE_1__["TimelineMax"]();
  tl.to(blurb, 0.35, {
    autoAlpha: 1,
    y: 1
  }, 'start+=0.3').to(mask, 0.5, {
    autoAlpha: 0,
    delay: 0.25
  }, 'start').fromTo(btn, 0.35, {
    autoAlpha: 0,
    y: 0
  }, {
    autoAlpha: 1,
...
$('.menu-icon').parent().click(function () {
  $(this).find('.menu-icon').toggleClass('on'); // $('.mobile-menu').slideToggle();
...
$('.pipeline .arrow').click(function () {
  $(this).parent().parent().next('.toggle-content').slideToggle();
});
/* Mobile menu */
...
(function () {
  $(window).scroll(function () {
    $('.nav-link-secondary').toggleClass("on", $(window).scrollTop() > 500);
    $('.nav-link-secondary').hasClass('on') ? $('.mobile-menu').addClass('active-sticky') : $('.mobile-menu').removeClass('active-sticky');
  });
  var viewportWidth = $(window).width();
  var navHeight = $('nav').innerHeight(); // $('body.overflow .mobile-menu').css('top', navHeight + 'px');

  if (viewportWidth <= 1280) {
    $('.nav-link-secondary').find('.interactive-icon span:last-child').click(function () {
      $('nav').find('.menu-icon').addClass('on');
      $('body.overflow .mobile-menu').css('top', navHeight + 'px');
    });
    $('nav').find('.interactive-icon span:last-child').click(function () {
      $('body.overflow .mobile-menu').css('top', navHeight + 'px');
    });
    $('nav').find('.menu-icon').click(function () {
      $('.nav-link-secondary').find('.menu-icon').removeClass('on');
    });
  }
...
(function () {
  ...
  function mobileViewUpdate() {
    ...
    if (viewportWidth <= 980) {
      $(".mobile-slick-1").addClass("active");
      $(".mobile-slick-2").addClass("active");
      elSlider('.mobile-slick-1', '.mobile-slick-1 + .controls .next', '.mobile-slick-1 + .controls .prev');
      elSlider('.mobile-slick-2', '.mobile-slick-2 + .controls .next', '.mobile-slick-2 + .controls .prev');
    } else if (viewportWidth > 980) {
      $(".mobile-slick-1").removeClass("active");
      $(".mobile-slick-2").removeClass("active");
    }
  }
...
(function () {
  $('.interactive-icon').find('.search').click(function () {
    $('.modal.search').toggleClass('on');
    $("#search-form").find('[autofocus]').focus();
  });
})();
/* Refences Toggle */
...
(function () {
  $('.toggle .arrow').click(function () {
    $(this).toggleClass('on');
    $(this).nextAll('ol, ul').slideToggle();
  });
  $('.pipeline .row .arrow').click(function () {
    $(this).toggleClass('active');
    $(this).parent().parent().toggleClass('active');
  }); // Contact Toggle

  $('.list-contact.toggle .toggle.icon').click(function () {
    var $this = $(this);
    $this.toggleClass('on');
    $this.next('div').slideToggle();
    $this.parent().parent().parent().nextAll().find('div:last-child').slideUp();
    $this.parent().parent().parent().prevAll().find('div:last-child').slideUp();
    $this.parent().parent().parent().nextAll().find('.toggle.icon').removeClass('on');
    $this.parent().parent().parent().prevAll().find('.toggle.icon').removeClass('on');
    $this.parent().nextAll().find('div:last-child').slideUp();
    $this.parent().prevAll().find('div:last-child').slideUp();
    $this.parent().nextAll().find('.toggle.icon').removeClass('on');
    $this.parent().prevAll().find('.toggle.icon').removeClass('on');
  });
  $('#united-states + h2 + div').find('.toggle.icon').addClass('on'); // Secondary toggle menu
	
  $('.nav-link-secondary .trigger').click(function () {
    $('.nav-link-secondary ul').not('.sec-menu-wrap ul').slideToggle();
    $('.sec-menu-wrap').toggleClass('active');
  ...
  _createClass(ModalVideo, [{
    ...
    value: function getYoutubeUrl(youtube, videoId) {
      ...
      if (youtube.nocookie === true) {
        return '//www.youtube-nocookie.com/embed/' + videoId + '?rel=0&enablejsapi=1';
      }

      return '//www.youtube.com/embed/' + videoId + '?rel=0&enablejsapi=1';
    }
  }, {
    key: 'getFacebookUrl',
...
__webpack_require__(/*! /Users/recondo/Sites/stage.biomarin.com/wp-content/themes/biomarin/assets/js/app.js */"./assets/js/app.js");
module.exports = __webpack_require__(/*! /Users/recondo/Sites/stage.biomarin.com/wp-content/themes/biomarin/assets/scss/app.scss */"./assets/scss/app.scss");
